...
export default function FavoritesPage() {
  ...
  const addToCart = async (item: FavoriteItem) => {
    try {
      // Add to cart logic - you can use your cart store
      toast.success(`Added ${item.menuItemName} to cart`);
    } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-2">
            Your favorite items from restaurants
          </p>
        </div>
        ...
        {favorites.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500 mb-6">Start adding your favorite items from restaurants</p>
            <Link
              href="/"
                ...
                <div className="p-4">
                  ...
                  <div className="flex gap-2 mt-4">
                    <button
                      ...
                      className="flex-1 bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 transition font-medium flex items-center justify-center gap-2 text-sm"
                    >
